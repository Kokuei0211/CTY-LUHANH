...
<div class="">
	<div class="content-wrapper">
		<div class="content-heading">
         	 <!-- END Language list--><a style="color: #929292; cursor: pointer;" href="<?php echo base_url()?>admin/diadiem">Địa Điểm</a> <a style="color: #fcba2f;"> > Tạo Địa Điểm</a>
   		</div>
	</div>
	<div class="row">
					...
					<form id="form_create_dd" method="post" enctype="multipart/form-data" data-parsley-validate="">
						...
						<div class="row" style="margin: 5px 20px">
							<div class="div_margin_bottom">
	                            ...
	                            <div class="row">
	                            	<input class="form-control" required type="number" name="ma_tinh">
		                       	</div>
	                       	</div>
	                       	<div class="div_margin_bottom">
	                        	<label class="row control-label" for="inputContact11">Địa chỉ</label>
	                            <div class="row">
	                            	<input type="text" id="address_from" name="dia_diem" class="form-control" required="required">
		                       	</div>
	                       	</div>
	                       	<div class="div_margin_bottom">
	                        	<label class="row control-label" for="inputContact11">Mô tả</label>
	                            <div class="row">
	                            	<textarea row="4" maxlength="1000" name="mo_ta" class="form-control" required="required"> </textarea>
		                       	</div>
	                       	</div>
	                       	<div class="" style="margin-top:20px">
	                       		...
	                       		<div class="col-sm-6 center_item">
	                       			<input name="Create_DiaDiem" class="btn btn-info" value="Create" type="submit">
	                       		</div>
	                       	</div>
						</div>
					</form>
