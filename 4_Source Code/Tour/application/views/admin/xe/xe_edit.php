...
<div class="">
	<div class="content-wrapper">
		<div class="content-heading">
         	 <!-- END Language list--><a style="color: #929292; cursor: pointer;" href="<?php echo base_url()?>admin/xe">Xe</a> <a style="color: #fcba2f;"> > Sửa Xe</a>
   		</div>
	</div>
	<div class="row">
						...
						<div class="row" style="margin: 5px 20px">
							...
							<div class="div_margin_bottom">
	                       	...
	                       	<div class="" style="margin-top:20px">
	                       		...
	                       		<div class="col-sm-6 center_item">
	                       			<input name="Edit_Xe" class="btn btn-info" value="Save" type="submit">
	                       		</div>
	                       	</div>
						</div>
					</form>
