;(function (global, factory) {
    ...
    function createAdderSpec(direction, name) {
        return function (val, period) {
            var dur, tmp;
            //invert the arguments, but complain about it
            if (period !== null && !isNaN(+period)) {
            ...
            addSubtractSpec(this, dur, direction);
            
            return this;
        };
    }
    
    function addSubtractSpec (mom, duration, isAdding, updateOffset) {
        var milliseconds = duration._milliseconds,
            days = absRound(duration._days),
            months = absRound(duration._months);
        ...
        if (milliseconds) {
        	var oldHour = get(mom, 'Hours');
            mom._d.setTime(mom._d.valueOf() + milliseconds * isAdding);
            var newHour = get(mom, 'Hours');
            
            if(newHour > oldHour) {
            	mom._d.setTime(mom._d.valueOf() - 3600000);
    ...
    var addSpec   = createAdderSpec(1, 'addSpec');
    var subtract = createAdder(-1, 'subtract');
    var subtractSpec = createAdderSpec(-1, 'subtractSpec');
    ...
    proto.subtractSpec     	= subtractSpec;
